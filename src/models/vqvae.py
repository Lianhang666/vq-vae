...
fsq_levels_lookup = {
    ...
    1024: [8, 5, 5, 5], #1000
    4096: [7, 5, 5, 5, 5], #4375
    16384: [8, 8, 8, 6, 5], #15360
    65536: [8, 8, 8, 5, 5, 5], #64000
}
...
class VQVAE(nn.Module):
    def __init__(
        ...
        self.encoder = Encoder(in_channels, self.hidden_dims, 'relu4')
        self.decoder = Decoder(in_channels, self.hidden_dims, 'relu4')
